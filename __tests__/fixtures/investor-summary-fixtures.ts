...
export const INVESTOR_SUMMARY_PRESENTATION_COMPLETE_FIXTURE: InvestorSummaryViewModel = {
  deal: {
    dealId: "deal-summary-complete-001",
  ...
  activeTasks: [
    {
      taskId: "task-summary-complete-001",
      title: "Review lender criteria",
      taskType: "DUE_DILIGENCE",
      status: "OPEN",
      priority: "HIGH",
      dueDate: "2026-06-12",
      blockerReason: "Waiting on lender pack.",
      createdAt: "2026-06-10T09:00:00.000Z",
      completedAt: null,
    },
    {
      taskId: "task-summary-complete-002",
      title: "Confirm solicitor review",
      taskType: "EVIDENCE",
      status: "IN_PROGRESS",
      priority: "MEDIUM",
      dueDate: null,
  ...
  latestOffer: {
    offerId: "offer-summary-complete-001",
    amount: 118000,
    offerType: "INITIAL",
    offerStatus: "PENDING",
    rationale: "Prepared after canonical summary review.",
    sellerResponse: "Awaiting reply",
    createdAt: "2026-06-11T08:30:00.000Z",
  },
  recommendedNextAction: {
    source: "PERSISTED_NEXT_ACTION",
...
export const INVESTOR_SUMMARY_PRESENTATION_BLOCKED_FIXTURE: InvestorSummaryViewModel = {
  deal: {
    dealId: "deal-summary-blocked-001",
    address: "12 Lake View Road, Leeds",
  },
...
export const INVESTOR_SUMMARY_PRESENTATION_UNAVAILABLE_FIXTURE: InvestorSummaryViewModel = {
  deal: {
    dealId: "deal-summary-unavailable-001",
    address: "Address unavailable",
  },
...
export const INVESTOR_SUMMARY_PRESENTATION_EMPTY_FIXTURE: InvestorSummaryViewModel = {
  deal: {
    dealId: "deal-summary-empty-001",
...
export const INVESTOR_SUMMARY_PRESENTATION_WARNING_FIXTURE: InvestorSummaryViewModel = {
  deal: {
    dealId: "deal-summary-warning-001",
    address: "8 Marina Crescent, Manchester",
  },
  purchasePrice: 98000,
  gdvRange: {
  ...
  investorShield: {
    ...
    blockedGates: [
      ...
      },
      {
        ...
        gateType: "advisory",
        blockerReason: "Advisory review remains incomplete.",
      },
    ],
  },
  activeTasks: [
    {
      taskId: "task-summary-warning-001",
      title: "Request lender criteria evidence",
      taskType: "DUE_DILIGENCE",
      status: "BLOCKED",
      priority: "HIGH",
      dueDate: "2026-06-15",
      blockerReason: "Waiting on lender criteria pack.",
      createdAt: "2026-06-10T12:00:00.000Z",
      completedAt: null,
    },
  ],
  latestOffer: {
    offerId: "offer-summary-warning-001",
    amount: 0,
    offerType: "INITIAL",
    offerStatus: "DRAFT",
    rationale: null,
...
export const INVESTOR_SUMMARY_PRESENTATION_FIXTURES = [
