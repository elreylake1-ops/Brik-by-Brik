...
Status note: Phase 4A Step 6C offer repository helpers created. No offer API, UI, task, note, command view, saved-deal engine mutation, or calculator behavior added.
