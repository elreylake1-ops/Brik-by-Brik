...
const defaultInputs: DealInputs = { purchasePrice: 0, gdv: 0, refurbCost: 0 }
    ...
    <main className="min-h-screen bg-gray-50 px-4 py-10">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">70% Rule — Fix &amp; Flip Calculator</p>
        ...
        <div className="mt-10 border-t border-gray-200 pt-6 text-center">
          ...
          <p className="mt-1 text-xs text-gray-400">The 70% rule is a guide only, not financial advice.</p>
        </div>
      </div>
    </main>
  )
